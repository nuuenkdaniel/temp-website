  ...
  return (
    <nav className="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto border-b border-stone-100 bg-white/50 backdrop-blur-sm sticky top-0 z-50">
      ...
      <div className="hidden md:flex gap-8 text-stone-600 font-medium">
        ...
        <Link href="/therapists" className="hover:text-primary-700 transition-colors">Therapists</Link>
        <Link href="/about" className="hover:text-primary-700 transition-colors">About</Link>
        <Link href="/contact" className="hover:text-primary-700 transition-colors">Contact Us</Link>
      </div>
